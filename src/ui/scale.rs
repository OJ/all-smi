...
const POWER_LIMIT_KEYS: [&str; 3] = [
    detail_keys::POWER_LIMIT_CURRENT,
    detail_keys::POWER_LIMIT_MAX,
    detail_keys::POWER_LIMIT_DEFAULT,
];
...
mod tests {
    ...
    fn power_range_limit_key_priority() {
        let mut detail = HashMap::new();
        detail.insert(detail_keys::POWER_LIMIT_MAX.to_string(), "450".to_string());
        detail.insert(
